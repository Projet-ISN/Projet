...
class FenetreRobot(tk.Tk):
    ...
    def __init__(self, root):
        ...
        style.configure("TNotebook.Tab", background="#e1a4b6", foreground="white", font=("Helvetica", 20), padding=10)
        style.configure("TFrame", background="#fbe8ea")
        style.configure("TLabel", background="#fbe8ea", font=("Helvetica", 20), foreground="#4b2e2e")
    ...
    def creation_portrait(self):
        ...
        skin_scale = tk.Scale(frame, from_=0, to=100, orient='horizontal', variable=self.skin_tone,
                              ...
                              bg="#fbe8ea", fg="#4b2e2e", width=20,font=("Helvetica", 20),
                              troughcolor="#e1a4b6", highlightbackground="#fbe8ea")
